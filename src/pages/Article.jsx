...
const copy = {
  es: {
    ...
    originalPrint: "Extracto de la Publicación Impresa",
    printLabel: "Fragmento del texto original tal como fue publicado en la edición impresa. Para leer el artículo completo, consulte las páginas escaneadas a continuación.",
    outro: "Reflexión",
  ...
  en: {
    ...
    originalPrint: "Print Publication Excerpt",
    printLabel: "An excerpt from the original text as it appeared in the print edition. To read the full article, see the scanned pages below.",
    outro: "Reflection",
